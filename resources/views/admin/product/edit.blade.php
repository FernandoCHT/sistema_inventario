            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="nombre" class="form-control" type="text" name="nombre" value="{{$product->nombre}}" required>
                    </div>

                    <div class="form-group">
                        <label for="precio_venta">Precio de venta</label>
                        <input id="precio_venta" class="form-control" type="number" name="precio_venta" value="{{$product->precio_venta}}" required>
                    </div>
