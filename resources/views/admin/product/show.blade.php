                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <a href="{{url('change_status/products', $product)}}" class="btn btn-success btn-block">Activo</a>
                            @else
                            <a href="{{url('change_status/products', $product)}}" class="btn btn-danger btn-block">Desactivado</a>
                            @endif
                        </div>
