    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('clients')}}">Proveedores</a></li>
        ...
        <div class="col-12">
            <div class="card">
                            ...
                            <div class="profile-feed">
                                <div class="d-flex align-items-start profile-feed-item">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <hr>
                                        <strong><i class="fas fa-address-card mr-1"></i> Numero de identificación</strong>
                                        <p class="text-muted">
                                            {{$client->RFC}}
                                        </p>
                                        <hr>
                ...
                <div class="card-footer text-muted">
                    <a href="{{url('clients')}}" class="btn btn-primary float-right">Regresar</a>
                </div>
            </div>
        </div>
    </div>
